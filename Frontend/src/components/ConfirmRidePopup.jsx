        ...
        <div className='flex justify-between gap-5 flex-col items-center'>
          ...
          <div className='mt-6 w-full'>
            <form onSubmit={(e)=>{
                ...
                <input value={otp} onChange={(e)=>setOTP(e.target.value)} className="bg-[#eeee] px-6 py-4 font-mono text-lg rounded-lg w-full mt-3" type="text" placeholder='Enter OTP' />

            <Link to='/captain-riding' className='w-full flex justify-center mt-5 bg-green-600 text-white font-semibold p-3 rounded-lg'>Confirm</Link>
          <button onClick={()=>{
